...
import 'package:cinema_app/features/authetication/controllers/sign_up/verify_email.dart';
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children: [
              // Image
              Image(image: const AssetImage(MyImgStrings.verifyEmail), width: MyHelperFunctions.screenWidth()*0.6,),
